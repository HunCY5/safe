...
private let businessNumberTextField: UITextField = {
    let textField = UITextField()
...
private let ManagerIDTextField: UITextField = {
    let textField = UITextField()
...
private func setupConstraints() {
    ...
    NSLayoutConstraint.activate([
        ...
        self.employeeNumberLabel.topAnchor.constraint(equalTo: self.businessNumberTextField.bottomAnchor, constant: 16),
